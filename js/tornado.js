var s = c.width = c.height = 500,
		...
		opts = {
			text: 'Hello my name is Alex, and this my #Day77 of 100DaysOfCode',
			count: 150,
			baseStartDist: 100,
			addedStartDist: 60,
			startY: 100,
...
Particle.prototype.step = function(){
	...
	if( this.y < opts.endY && Math.random() < 0.1 )
		this.reset();
};
...
function anim(){
	...
	if( particles.length < opts.count && Math.random() < 0.6 )
